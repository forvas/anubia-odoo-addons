...
# This is just a copy of the original file (except adapted for PEP8)
# in 'account' module, but it is needed due to a weird situation:
# If this file is not present, the account_invoice_report view fails
# to be rebuilt on updates, thus breaking related reports, graphs,...
